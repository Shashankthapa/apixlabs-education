    ...
    <>
      ...
      <div className="flex flex-col items-center justify-start w-full gap-[100px] bg-gray-100">
        <div className="flex flex-col items-center justify-start w-full gap-12">
          ...
          <div className="flex flex-col items-start justify-start w-full gap-[5px] p-5 md:px-5 bg-red-50 max-w-7xl rounded-[20px]">
            ...
            <div className="flex flex-row md:flex-col justify-between items-center w-[99%] md:w-full ml-2.5 gap-[420px] md:gap-10 md:ml-0">
              <Heading size="3xl" as="h1" className="w-[full] !font-semibold">
                <>
                  Educatsy has the
                  <br />
                  qualified mentor
              ...
              <div className="flex flex-row justify-end w-[35%] md:w-full py-[3px]">
                <div className="flex flex-col items-center justify-start w-[97%] mb-1">
                  <div className="h-[198px] w-[99%] md:w-full relative">
                    ...
                    <div className="flex flex-col items-start justify-center w-max h-max left-0 bottom-0 right-0 top-0 m-auto absolute md:hidden">
        ...
        <div className="flex flex-row justify-center w-full">
          ...
          >
            <TabList className="flex flex-row items-center md:flex-col justify-between w-full gap-20 px-26 md:gap-10">
              <Tab className="flex md:justify-center w-fit sm:w-full md:ml-0 p-3 text-gray-900 text-base font-medium">
                All Mentors
              </Tab>
              <Tab className="flex md:justify-center w-fit sm:w-full md:ml-0 p-4 text-gray-900 text-base font-medium">
                For Kindergarten
              </Tab>
              <Tab className="flex md:justify-center w-fit sm:w-full md:ml-0 p-3 text-gray-A700 text-base font-medium">
                For high school
              </Tab>
              <Tab className="flex md:justify-center w-fit sm:w-full md:ml-0 p-3 text-gray-900 text-base font-medium">
                For college
                      ...
                      <React.Fragment key={Math.random()}>
                        <div className="flex flex-row md:flex-col gap-10 mx-auto">
                          ...
                          <AllMentorsMaincard
                            ...
                            className="flex flex-col items-center justify-start w-[21%] md:w-full gap-2.5"
                          />
                        </div>
                      </React.Fragment>
                    ))}
            ...
            <div className="flex flex-row sm:flex-col justify-center items-center w-full gap-[19px]">
              <Button
                color="white_A700"
                size="xs"
                shape="round"
                ...
                className="w-[3%] md:w-[5%] sm:p-0 !rounded-md"
              >
              ...
              <Text
                as="p"
                className="sm:m-0 md:ml-0 !text-gray-900 !font-medium"
              >
                {sliderState}
              </Text>
              {/* <Button
              ...
              <Text
                as="p"
                className="flex items-center justify-center sm:m-0 md:m-0 mr-5 !text-gray-900 !font-medium"
              >
                <div className="mr-5">of</div>
                <div>03</div>
              </Text>
              <Button
                color="white_A700"
